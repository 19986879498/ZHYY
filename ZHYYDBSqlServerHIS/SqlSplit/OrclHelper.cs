...
namespace ZHYYDBSqlServerHIS.SqlSplit
{
    ...
    {
        public IConfigurationRoot root = new ConfigurationBuilder().AddJsonFile("SqlServerDB.json").Build();
        ...
        public string GetFZRead()
        {
            ...
            //    num = 0;
            //}
            string ReturnRes = ReadStr[new Random().Next(0, ReadStr.Count())];
            //num++;
            return ReturnRes ;
        }
        /// <summary>
        ...
        public string GetLXRead()
        {
            ...
            //    num = 0;
            //}
            string ReturnRes = ReadStr[(new Random().Next(0, ReadStr.Count()))%ReadStr.Count()];
            num++;
            return ReturnRes;
        }
        /// <summary>
        ...
        public string GetQZRead()
        {
            ...
            string ReturnRes = ReadStr[new Random().Next(0, QZreadStr.Count())];
            num++;
            return ReturnRes;
        }
        /// <summary>
